...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = 'fcbf5f096273cb';
        $mail->Password = '073c49cb5c1d5c';
        ...
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong>
         ...
         solo debes confirmarla presionado el 
         siguiente enclace</p>";
         $contenido .= "<p>Presiona aquí: 
         <a href='http://localhost:3000/confirmar-cuenta?token=". $this->token ."'>Confirmar Cuenta</a></p>";
         $contenido .= "Si tu no solicitaste esta cuenta, puedes ignorar el mensaje</p>";
         $contenido .= "</html>";
         $mail->Body = $contenido;
